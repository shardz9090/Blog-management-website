...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
        <a href="<?php echo base_url(); ?>" class="navbar-brand bg-primary d-flex align-items-center px-4 px-lg-5">
            <h2 class="mb-2 text-white">BLOG</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                function is_active_page($page_name)
                {
                    ...
                    return (strpos($current_url, $page_name) !== false);
                }
                ?>
                ...
                <?php if ($this->session->userdata('log') === 'logged') { ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" onclick="showLogoutConfirmation()" class="nav-item nav-link">Sign Out</a></li>
                        </ul>
                    </li>
                <?php } else { ?>
                    <li>
